    ...
    <script type="text/javascript">
        ...
        if(isIE){
            ...
            if(safariVersion <= DEFAULT_VERSION ){
                window.location.href="/admin/iecheck.action";
            }
        }
    </script>
</head>
...
<div class="container-fluid">
    <div class="text-right" style="padding-top: 10px;">
        <input type="button" id="btnRegister" class="btn btn-primary hidden" data-toggle="modal" value="注册"></input>
    </div>
...
<script type="text/javascript" src="/js/system/canvas.js"></script>
